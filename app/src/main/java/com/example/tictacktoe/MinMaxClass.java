...
public class MinMaxClass {
    ...
    public int driverCode(int[] gameState){
        char[][] board = boardGenerator(gameState);
...
// the value of the board
    ...
    public char[][] boardGenerator(int[] gameState){
        char[][] board = new char[3][3];
        for(int i =0; i < 3; i++){
            for (int j =0; j <3; j++){
                if(gameState[3*i+j]==2){
                    board[i][j] = '_';
                }else if(gameState[3*i+j]==1){
                    board[i][j] = 'x';
                }else{
                    board[i][j] = 'o';
                }
